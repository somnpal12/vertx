package com.example.vertx_fileupload;

import com.example.vertx_fileupload.verticle.FileUploadVerticle;
...
public class MainVerticle extends AbstractVerticle {
  ...
  List<AbstractVerticle> verticleList = Arrays.asList(new FileUploadVerticle());
