...
@Wid(widfile="MyWorkItemDefinitions.wid", name="MyWorkItemDefinitions",
        ...
        defaultHandler="mvel: new Y.MyWorkItemWorkItemHandler()",
        documentation = "MyWorkItemHandler/index.html",
        category = "MyWorkItemHandler",
        ...
        mavenDepends={
            @WidMavenDepends(group="com.redhat", artifact="MyWorkItemHandler", version="7.29.0.Final")
        },
        serviceInfo = @WidService(category = "MyWorkItemHandler", description = "${description}",
                keywords = "",
